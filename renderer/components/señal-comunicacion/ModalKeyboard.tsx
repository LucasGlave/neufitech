...
const ModalKeyboard = ({
  ...
  return (
    <div
      className="flex flex-col gap-8 pt-12 items-center bg-keyboardHeader rounded-lg shadow-md h-[100%] w-[100%]"
      ref={containerRef}
    >
      {modalProps !== null && (
        <ConfirmationModal
      ...
      <div className="bg-zinc-900 flex flex-col w-full h-full gap-4 pt-4">
