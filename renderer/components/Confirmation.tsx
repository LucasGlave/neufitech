...
const Confirmation: React.FC<ConfirmationProps> = ({ question, onConfirm, onCancel }) => {
    return (
        <div className={`absolute items-center transition-all duration-100 justify-center gap-5 flex flex-col h-screen w-full px-16 py-8 backdrop-blur-sm z-50 bg-[#000000af]`}>
