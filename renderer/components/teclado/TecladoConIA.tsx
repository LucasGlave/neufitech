...
const Teclado = () => {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="w-full flex flex-row justify-between items-center px-4 pt-4">
        <ButtonAnimation
        ...
        />
        <div
          className={`flex flex-col w-1/2 gap-2 text-white ${
            !responses[1] && "opacity-50"
          }`}
        >
          <div className="flex flex-row w-full gap-2">
            ...
            <ButtonAnimation
              ...
              speakText={responses[1]}
              propClass="w-20 h-20 bg-keybackground"
            />
            <div className="bg-zinc-900 w-full rounded-lg flex items-center px-4">
              <h3 className="text-2xl">{responses[1]}</h3>
            </div>
          </div>
          <div className="flex flex-row w-full gap-2">
            {/* <button className="border-2 border-zinc-900 bg-white w-14 h-14 rounded-lg"></button> */}
            <ButtonAnimation
              disabled={isOff}
              svg='<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="0.72"></g><g id="SVGRepo_iconCarrier"> <path d="M16 9C16.5 9.5 17 10.5 17 12C17 13.5 16.5 14.5 16 15M19 6C20.5 7.5 21 10 21 12C21 14 20.5 16.5 19 18M13 3L7 8H5C3.89543 8 3 8.89543 3 10V14C3 15.1046 3.89543 16 5 16H7L13 21V3Z" stroke="#FFFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>'
              speakText={responses[2]}
              propClass="w-20 h-20 bg-keybackground"
            />
            <div className="bg-zinc-900 w-full rounded-lg flex items-center px-4">
              <h3 className="text-2xl">{responses[2]}</h3>
            </div>
          </div>
          <div className="flex flex-row w-full gap-2">
            {/* <button className="border-2 border-zinc-900 bg-white w-14 h-14 rounded-lg"></button> */}
            <ButtonAnimation
              disabled={isOff}
              svg='<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="0.72"></g><g id="SVGRepo_iconCarrier"> <path d="M16 9C16.5 9.5 17 10.5 17 12C17 13.5 16.5 14.5 16 15M19 6C20.5 7.5 21 10 21 12C21 14 20.5 16.5 19 18M13 3L7 8H5C3.89543 8 3 8.89543 3 10V14C3 15.1046 3.89543 16 5 16H7L13 21V3Z" stroke="#FFFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>'
              speakText={responses[3]}
              propClass="w-20 h-20 bg-keybackground"
            />
            <div className="bg-zinc-900 w-full rounded-lg flex items-center px-4">
              <h3 className="text-2xl">{responses[3]}</h3>
            </div>
          </div>
        </div>
      ...
      <div className="flex items-center gap-2 justify-between w-full px-4">
        ...
        <div className="flex w-[60%] flex-col justify-center items-center gap-2">
          <VoiceRecognition setter={setResponses} />
          <textarea
            value={output}
