    ...
    <div className="h-[100vh] flex flex-row bg-white">
      <div className="w-full relative flex items-center justify-center">
        ...
        >
          ...
          <div className=" h-[60%] w-full flex flex-col items-center justify-center gap-6 text-xl">
            {activeButtons["interaccion-rapida"] && (
              <ButtonAnimation
                disabled={isOff}
                functionKeyboard={{ funct: "interaccionRapida", state: changeState }}
                buttonBorder="border-green-700"
