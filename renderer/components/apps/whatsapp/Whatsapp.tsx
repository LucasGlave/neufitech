  ...
  return (
    <div className="h-[100vh] flex flex-row bg-white">
      <div className="w-full relative flex items-center justify-center">
        ...
        />
        <div
          className={`flex flex-col z-20 justify-between p-2 w-[12%] h-full border-2 border-red`}
        >
          <ButtonAnimation
        ...
        <div
          style={{ gap: gap }}
          className={`flex flex-col z-20 justify-start p-2 w-[12%] h-full border-2 border-red`}
        >
          <ButtonAnimation
